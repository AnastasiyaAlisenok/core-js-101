...
function encodeToRot13(str) {
  ...
  for (let i = 0; i < strArr.length; i += 1) {
    if (arr1.includes(strArr[i].toLowerCase())) {
      const ind = arr1.indexOf(strArr[i].toLowerCase());
      strArr[i] = strArr[i].toLowerCase() === strArr[i] ? arr2[ind] : arr2[ind].toUpperCase();
    } else if (arr2.includes(strArr[i].toLowerCase())) {
      const ind = arr2.indexOf(strArr[i].toLowerCase());
      strArr[i] = strArr[i].toLowerCase() === strArr[i] ? arr1[ind] : arr1[ind].toUpperCase();
    }
  }
  return strArr.join('');
}
